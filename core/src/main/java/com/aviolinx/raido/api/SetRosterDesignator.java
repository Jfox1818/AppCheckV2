 ...
 *         &lt;element name="RosterDesignator" type="{http://www.w3.org/2001/XMLSchema}string"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "SetRosterDesignator")
public class SetRosterDesignator {
    ...
    @XmlElement(name = "RosterDesignator", required = true, nillable = true)
